    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          ...
          size="sm"
          disabled={disabled}
          className={cn("h-8 w-full justify-start gap-2 px-2 font-medium", className)}
          {...props}
        >
          <span
            className="size-4 shrink-0 rounded border shadow-[inset_0_0_0_1px_rgba(255,255,255,0.18)]"
